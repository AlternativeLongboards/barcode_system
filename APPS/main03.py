...
#host = '213.32.89.50'
host = '192.168.1.200'
port = 6636                                                                                                             # tu zmienic !!!
port2 = 6736                                                                                                            # tu zmienic !!!
    ...
    BoxLayout:
        ...
        BoxLayout:
            ...
            BoxLayout:
                ...
                size_hint: 1, .18
                Label:
                    text: '[b]SANDING ROOM - 03[b]'                                                                     # tu zmienic !!!
                    markup: 'True'
...
<InfoWindow>:
    ...
    size_hint: 0.8, 0.8
    title_align: 'center'
    title: 'BOARDS TO SAND'                                                                                              #tu zmienic
    BoxLayout:
        orientation: 'horizontal'
        BoxLayout:
            orientation: 'vertical'
...
class InfoWindow(Popup):
    ...
    def popup_count(self):
        ...
        while co < 20:
            ...
            if (co > 9):
                mo = str(co)
            code_win[co].text = str(collection_tosand.find({"model": mo}).count())                                      #tu zmienic !!
            co += 1
...
#        threading.Thread(target=self.message_read).start()
    ...
    def data_check(self):                                                                                               # tu_zmienic !!!
        ...
        check_counter = 0
        while (is_present == 0):
            is_present = collection_03.find({"code": read_code}).count()
            if (is_present > 0):
                data_added = 1
                break
            else:
    ...
    def comm_check(self):                                                                                               # tu zmienic !!!
        ...
        check_counter = 0
        while (is_present == 0):
            is_present = collection_tofinish.find({"code": read_code}).count()
            if (is_present > 0):
                comm_added = 1
                break
            else:
    ...
    def main_handling(self, *args):
        ...
        if (data != 0 and data != -1):
            ...
            if (len(worker_name) > 2 and sec == 0 and com == 0):
                ...
                if (worker != ""):
                    if (sec == 0 and com == 0):
                        if (collection_03.find({"code": read_code}).count() == 0):                                      # tu zmienic !!!
                            new_data = {
                                ...
                                "model": model,
                                "worker": worker,
                                "operation": "03",                                                                      # tu zmienic !!!

                            }
                            collection_03.insert_one(new_data)                                                          # tu zmienic !!!
                            print("added to 03 base : " + read_code)                                                    # tu zmienic !!!
                            ...
                            collection_tofinish.insert_one(new_data2)                                                   # tu zmienic !!!
                            i = db.tosand.delete_many({"code": read_code}).deleted_count                                # tu zmienic !!!  uwaga przy 00
                            ...
                            if (i < 1):
                                missing_code = {
                                    ...
                                    "code": read_code,
                                    "model": model,
                                    "missing": "02",                                                                    # tu zmienic !!!
                                    "timestamp": timestamp
                                }

                                collection_missingcodes.insert_one(missing_code)
                                print("missing in 02 base : " + read_code)                                              # tu zmienic !!!
