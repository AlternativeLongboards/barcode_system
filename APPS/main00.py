    ...
    BoxLayout:
        ...
        BoxLayout:
            ...
            BoxLayout:
                ...
                size_hint: 1, .18
                Label:
                    text: '[b]LAGGING ROOM - 00[b]'                                                                     # tu zmienic !!!
                    markup: 'True'
                        ...
                        BoxLayout:
                            ...
                            BoxLayout:
                                ...
                                Button:
                                    ...
                                    background_color: 0, .6156, .48235, 1
                                    background_normal: ''
                                    on_press:                                                                           # tu zmienic tylko dla 00
                                Label:
                                    size_hint: .1 , 1
                                Button:
                                    text: 'EXIT'
...
#        threading.Thread(target=self.message_read).start()
    ...
    def data_check(self):                                                                                               # tu_zmienic !!!
        ...
        check_counter = 0
        while (is_present == 0):
            is_present = collection_00.find({"code": read_code}).count()
            if (is_present > 0):
                data_added = 1
                break
            else:
    ...
    def comm_check(self):                                                                                               # tu zmienic !!!
        ...
        check_counter = 0
        while (is_present == 0):
            is_present = collection_topress.find({"code": read_code}).count()
            if (is_present > 0):
                comm_added = 1
                break
            else:
    ...
    def main_handling(self, *args):
        ...
        if (data != 0 and data != -1):
            ...
            if (len(worker_name) > 2 and sec == 0 and com == 0):
                ...
                if (worker != ""):
                    if (sec == 0 and com == 0):
                        if (collection_00.find({"code": read_code}).count() == 0):                                      # tu zmienic !!!
                            new_data = {
                                ...
                                "model": model,
                                "worker": worker,
                                "operation": "00",                                                                      # tu zmienic !!!

                            }
                            collection_00.insert_one(new_data)                                                          # tu zmienic !!!
                            print("added to 00 base : " + read_code)                                                    # tu zmienic !!!
                            ...
                            collection_topress.insert_one(new_data2)                                                    # tu zmienic !!!
